...
produtos = input('Produtos do estoque 1 (separados por vírgula): ').split(',')

produtos_2 = input('Produtos do estoque 2 (separados por vírgula): ').split(',')

print(produtos + produtos_2)
